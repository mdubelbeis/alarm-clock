...
const TodoIcons: React.FC<TodoIconsProps> = ({
  ...
  const handleBTN = (iconName: string) => {
    switch (iconName) {
      case "trashIcon":
        handleDeleteTodo(todo.todo, todo.id, todo.isComplete);
        break;
      case "editIcon":
        handleEditTodo(todo.todo, todo.id, todo.isComplete);
        break;
      case "completeIcon":
        handleCompleteTodo(todo.todo, todo.id, todo.isComplete);
        break;
      default:
